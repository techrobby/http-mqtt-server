...
import com.gk.server.http.exception.DefaultExceptionHandler;
	...
	public Long getAsLong(String key)
	{
		...
		catch (ClassCastException e)
		{
			if (value instanceof CharSequence)
			{
				...
				{
					logger.error("Cannot parse Long value for " + value + " at key " + key);
					return null;
				}
			}
			else
	...
	public Integer getAsInteger(String key)
	{
		...
		catch (ClassCastException e)
		{
			if (value instanceof CharSequence)
			{
				...
				{
					logger.error("Cannot parse Integer value for " + value + " at key " + key);
					return null;
				}
			}
			else
	...
	public Short getAsShort(String key)
	{
		...
		catch (ClassCastException e)
		{
			if (value instanceof CharSequence)
			{
				...
				{
					logger.error("Cannot parse Short value for " + value + " at key " + key);
					return null;
				}
			}
			else
	...
	public Byte getAsByte(String key)
	{
		...
		catch (ClassCastException e)
		{
			if (value instanceof CharSequence)
			{
				...
				{
					logger.error("Cannot parse Byte value for " + value + " at key " + key);
					return null;
				}
			}
			else
	...
	public Double getAsDouble(String key)
	{
		...
		catch (ClassCastException e)
		{
			if (value instanceof CharSequence)
			{
				...
				{
					logger.error("Cannot parse Double value for " + value + " at key " + key);
					return null;
				}
			}
			else
	...
	public Float getAsFloat(String key)
	{
		...
		catch (ClassCastException e)
		{
			if (value instanceof CharSequence)
			{
				...
				{
					logger.error("Cannot parse Float value for " + value + " at key " + key);
					return null;
				}
			}
			else
